...
class Commission(models.Model):
    ...
    commission_type = models.CharField(max_length=20, default=Commission.THEORY.value)
    ...
    def __str__(self):
        return f"{self.professor} - {self.classroom} - {self.commission_type}"

@admin.register(Commission)
class CommissionAdmin(admin.ModelAdmin):
    list_display = ("id","professor","classroom","commission_type","commission_schedule")