"""
Django settings for ucsm_project project.
...
SECRET_KEY = "django-insecure-8ob(4*ijdrszf#rnj0+8m2-b-9szrt7z)wc(@xpmzhz(hwsd()"
...
WSGI_APPLICATION = "ucsm_project.wsgi.application"
...
AUTH_USER_MODEL = "ucsm_api.Student"
REST_FRAMEWORK = {
